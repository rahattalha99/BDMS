...
<?php ?>
<h1 style="text-align:center;font-size:45px;">Welcome to BloodBank Management System</h1>
  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="image\bbl1.jpg" alt="image\_107317099_blooddonor976.jpg" width="100%" height="500">
      </div>
...
<br>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <a class="btn btn-lg btn-secondary btn-block" href="donate_blood.php" style="align:center; background-color:#ff8000;color:#273746 ">Become a Donor </a>
            </div>
        </div>
